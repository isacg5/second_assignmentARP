...
{
    // Get the coordinates of the middle of the circle
    ...
    // Get x by getting the middle parameter of the longest row
    ...
    // Get y by getting the middle parameter of the longest column
    for (int col = 0; col < W; col++)
    {
        c = 0;
        for (int row = 0; row < H; row++)
